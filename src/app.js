...
function generateTrips(event) {
  ...
  let context =
    "You are a trip advisor who has traveled the world. Give each destination on a new line <br/>";
  let prompt = `Give top 3 destinations about the city inserted in ${instructionsInput.value}`;
